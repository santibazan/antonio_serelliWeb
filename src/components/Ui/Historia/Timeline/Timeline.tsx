          ...
          <div>
            <ul className={styles["img-group"]}>
              ...
              <li className={styles["img-container"]}>
                ...
                <h3>1961-1962</h3>
                <h6>
                  Comienza a trabajar en irrigacion y es trasladado por 9 meses
                  a valle hermoso para realizar trabajos de
                  Hidronivometereología.{" "}
                </h6>
              </li>
              <li className={styles["img-container"]}>
                <img src="" alt="" />
              ...
              <li className={styles["img-container"]}>
                ...
                <h3>1964</h3>
                <h6>
                  III Salon Bienal de Artes Plásticas, obtiene el premio
                  estímulo por la obra "Dialogo de duendes"
                </h6>
              </li>
              <li className={styles["img-container"]}>
                <img src="" alt="" />
                ...
                <h6>
                  {" "}
                  Bodas de oro de la unión comercial e industrial de Mendoza
                </h6>
              </li>
              <li className={styles["img-container"]}>
                <img src="" alt="" />
                <h3>1969</h3>
                <h6>
                  XVII salón de primavera de San Rafael, Gran Premio de Honor
                  "Cristeta González de Viñuela".
                </h6>
              </li>
              <li className={styles["img-container"]}>
                <img src="" alt="" />
              ...
              <li className={styles["img-container"]}>
                ...
                <h6>
                  {" "}
                  Tercer Tremio IX Salón Bienal Municipal de Artes Plásticas
                </h6>
              </li>
              <li className={styles["img-container"]}>
                <img src="" alt="" />
