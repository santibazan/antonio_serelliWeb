  ...
  return (
      ...
      <section className={styles.imagen}>
        ...
        <p>
          ...
          visuales, este recorrido propone un acercamiento a miradas personales
          que dialogan con el paisaje, la historia y la vida cotidiana de
          Mendoza.
        </p>
        <p>
          ...
          creativo atravesado por el entorno, las tradiciones y las experiencias
          propias de quienes habitan este territorio.
        </p>
        <p>
          Más que una simple muestra, esta sección busca poner en valor el arte
          local como una forma de expresión viva, en constante transformación, y
          como un puente entre los artistas y la comunidad. Un lugar para
          descubrir, contemplar y reconocer la fuerza creativa que define al
          arte mendocino.
        </p>
        </div>
      </section>
