    ...
    <div>
      <div className={styles.contentTallerSarelli}>
        ...
        <p>
          ...
          técnica se une con la emoción y el pensamiento. En esta parte del
          libro, las creaciones dialogan entre sí y con el espectador, mostrando
          una identidad artística definida y reconocible. Los frutos no son solo
