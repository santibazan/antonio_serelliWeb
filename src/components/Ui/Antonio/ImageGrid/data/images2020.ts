...
export const images: ImageItem[] = [
  { id: 1, src: "https://res.cloudinary.com/dovztsxyv/image/upload/v1771951558/Dos_pesos_e6uxre.jpg", title: "Dos pesos", description: "Mixta sobre tela", medida:"100 x 50 cm", anio:2020, size: "large" },
  { id: 2, src: "https://res.cloudinary.com/dovztsxyv/image/upload/v1774870498/Los_que_nos_piensan_sogy8y.jpg", title: "Los que nos piensan", description: "Collage sobre madera", medida:"90 x 60 cm", anio:2021, size: "medium" }, 
  ...
  { id: 4, src: "https://res.cloudinary.com/dovztsxyv/image/upload/v1774870264/Devoradores_aw7p8h.jpg", title: "Devoradores", description: "Collage sobre madera", medida:"90 x 60 cm", anio:2021, size: "medium" }, 
