    ...
    <div className={styles.contentTallerSarelli}>
      <div className={styles.contenedorGlobal}>
        ...
        <p>
          ...
          forma una sensibilidad hecha de silencios, afectos y contemplación;
          una memoria íntima que, lejos de quedar atrás, vuelve una y otra vez
          como semilla de su mirada y como sostén emocional de su pintura.
        </p>
        <p>
          ...
          Bellas Artes. No es solo una recomendación: es la mano de un maestro
          que “ sale a buscarlo ” para abrirle una puerta. Y desde ahí, desde
          esa infancia sencilla y ese llamado oportuno, comienza el camino de
